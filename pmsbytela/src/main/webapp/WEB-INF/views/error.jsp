...
.label-info {
  ...
  <body>
    ...
    <div class="container" style="margin-top:20px">
      ...
      <div  class="row">    
        <div class="col-lg-12">        
	      <h1 style="color:#2c3e50">Oops!! Something went really wrong!</h1>      
		  <br>
		  <img alt="" src="resources/images/programmer.jpg" class="img-responsive">
		  <h3 class="" >Please give it another <strong>shot !</strong><small> Anonimo Dev center is at your service.Please contact us soon!</small>		  
		  </h3>	 	  
