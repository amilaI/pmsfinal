...
.label-info {
  ...
  <body  style="background-color: rgba(252, 254, 249, 1);">
      ...
      <div class="container">
        ...
        <div style="height: 1px;" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">           
            <li><a href="#" id="backAgain" style="font-weight: bold;color:#1abc9c">Back</a></li>           
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
    ...
    <div class="container" style="margin-top:20px">
      ...
      <div  class="row">    
        <div class="col-lg-12">        
      <h3 style="color:#2c3e50">Edit Patient Details</h3>
            <form class="form-horizontal" role="form" action="editPatient" method="POST" enctype="multipart/form-data"  modelAttribute="file">
            	<input type="hidden"  name="id" id="id" value="${patientId}" />
            	<input type="hidden"  name="patient_CreatedAt" id="patient_CreatedAt" value="${patient.patient_CreatedAt}" />
            	<input type="hidden"  name="patient_Photo" id="patient_Photo" value="${patient.patient_Photo}" />
              <div class="form-group">
                <label for="inputEmail3" class="col-md-2 control-label">Patient Full Name</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" id="patientName" name="patientName" placeholder="Patient Full Name"  value="${patient.patient_Name}" />
                </div>               
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-1">
                  <input type="text" class="form-control" id="age" name="age" placeholder="Age"  value="${patient.patient_Age}" />
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="${patient.patient_Address}">
                </div>
                <label for="inputPassword3" class="col-sm-2 control-label">NIC</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="nic" name="nic" placeholder="NIC" value="${patient.patient_NIC}"  />
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="contactNo" name="contactNo" placeholder="Contact Number" value="${patient.patient_ContactNo}">
                </div>
                <label for="inputPassword3" class="col-sm-2 control-label">Email</label>
                <div class="col-sm-4">
                  <input type="email" class="form-control" id="email" name="email" placeholder="user@gmail.com" value="${patient.patient_Email}">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">                
                <input type="text" class="form-control" id="tags" name="tags" value="${tags}" data-role="tagsinput" placeholder="Add and press Enter" />
                </div>
              ...
              <hr>
    			<input type="hidden" name="existingimagePath" id="existingimagePath" value="${patient.patient_Photo}">
    ...
    <script type="text/javascript">
       $(document).ready(function() {
         $('#canclBtn').click(function() {          alert("sda");   
